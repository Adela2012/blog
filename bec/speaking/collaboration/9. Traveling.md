...
3. For Example, 🎈we can `not take part in unnecessary conferences` and `avoid unnecessary travels` by using IT systems such as video conferencing and E-mails `as substitutions for some expensive travels`.
...
9. 🎈When it comes to `local transport`, employees should be advised not to choose convenience over cost-effectiveness. For instance, a taxi is much less expensive than a chauffeured car.
